...
When evaluating in the lattice the integral becomes a sum over the entire velocity space:
...
Notice that we are not including explicitly the mass of the dark matter particle in this integrals because it is already included in the phase space definition.\\

Now that we have well defined macroscopic variables, we can proceed to choose an equilibrium function.
