...
Nacido en Bucaramanga, Colombia, el 4 de enero de 1997.

\section*{Áreas de Interés}
\begin{itemize}
\item Astronomía
\item Astrofísica
\item Métodos computacionales
\item Materia oscura.
\item Astropartículas.
\end{itemize}

\section*{Educación}
\noindent
\years{2015-2019}\textsc{Pregrado en Física\footnote{Fecha tentativa de grado}}\\ {\emph{Institución}}: Departamento de Física, Universidad de los Andes. {\emph{Tesis}}: Simulación de materia oscura colisional con un método de Lattice-Boltzmann. {\emph{Director}}: Dr. Jaime Forero.\\
...
\item Lenguajes de programación: C, Python, R,  Java y Bash.
\item Habilidades de ofimática.
\item Uso de software adicional: IRAF, \LaTeX, Maxima.
\end{itemize}
